package com.notification.presenter;
...
import com.notification.model.IMainModel;
import com.notification.model.impl.MainModel;
...
public class MainPresenter {
    ...
    private PendingIntent getDefalutIntent(int flags) {
        PendingIntent pendingIntent = PendingIntent.getActivity(mActivity, 2, new Intent(mActivity, MainActivity.class), flags);
